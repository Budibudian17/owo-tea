/**
 * Marquee Menu Slider styles for OWO TEA
 * Infinite horizontal scrolling menu names
 */

export const marqueeStyles = {
  container: 'w-full overflow-hidden bg-[#F4F1EA] py-2 pb-20',
...
export type MarqueeStyles = typeof marqueeStyles;
